// Dump the function at cs=168:0x520631 that writes [0x56d226]
...
function dumpRegion(label, base, len) {
  console.log(`\n${label}:`);
...
// 0x520631 writes [0x56d226]. Let me dump function around it.
// Also 0x51fe14 (the decision function).
dumpRegion('0x51fdec (port helper)', 0x51fdec, 0x30);

// Check the value written at 0x520631
// Bytes around 0x520631:
//   0x56d226 write op = "89 15" (MOV [disp32], EDX)
// Let me decode what registers go into [0x56d226]
