// Dump DOOM's actual PIT handler at cs=168:0x522ed0
...
dumpRegion('PIT handler 0x522ed0', 0x522ed0, 0x200);
dumpRegion('SB handler (originally at 0x5206dc)', 0x5206dc, 0x100);
dumpRegion('Keyboard handler 0x525860', 0x525860, 0x100);
