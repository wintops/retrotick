// Dump I_StartupSound function context
...
// Dump memory around I_StartupSound caller sites
dumpRegion('Around 0x525e00 (I_StartupSound candidate)', 0x525e00, 0x200);
dumpRegion('Around 0x526900 (other caller)', 0x526900, 0x200);
