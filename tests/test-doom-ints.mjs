// Trace INT dispatches + [0xa42] writes side by side.
...
mem.writeU32 = function(addr, val) {
  if (addr === 0x27C22) {
    ...
    console.log(`[A42W] val=0x${val.toString(16)} cs=${cpu.cs.toString(16)}:${eipAfter.toString(16)} ss=${cpu.ss.toString(16)} esp=${(cpu.reg[4]>>>0).toString(16)} steps=${emu.cpuSteps}`);
  }
